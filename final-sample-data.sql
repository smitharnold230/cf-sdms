-- Final working sample data with correct constraints

-- Add events using existing user IDs
...
-- Add notifications using only allowed types: 'system','event','workshop','certificate','points'
...
-- Add analytics events for existing users
