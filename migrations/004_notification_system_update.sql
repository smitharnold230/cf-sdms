-- Migration 004: Notification System - Update existing tables and add new ones
-- Alters existing notifications table and creates new notification-related tables
...
ALTER TABLE notifications ADD COLUMN scheduled_for DATETIME;
...
ALTER TABLE notifications ADD COLUMN priority TEXT NOT NULL DEFAULT 'medium' CHECK (priority IN ('low', 'medium', 'high', 'urgent'));
