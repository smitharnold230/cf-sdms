...
export default function WorkshopsPage() {
  ...
  const fetchWorkshops = async () => {
    try {
      ...
      const response = await facultyApi.getWorkshops();
      if (response.success) {
          ...
          {loadingWorkshops ? (
            ...
            <div className="space-y-4">
              {workshops.map((workshop) => (
                <div key={workshop.id} className="border border-gray-200 rounded-lg p-6 hover:bg-gray-50">
                  <div className="flex items-center justify-between">
                      ...
                      <div>
                        ...
                        <div className="flex items-center space-x-4 text-sm text-gray-500 mt-2">
                          <div className="flex items-center">
                            ...
                            {new Date(workshop.start_datetime).toLocaleDateString()} at{' '}
                          ...
                          <div className="flex items-center">
                            <Users className="w-4 h-4 mr-1" />
                            Created by {workshop.created_by_name}
                          </div>
                        </div>
                      </div>
                    </div>
